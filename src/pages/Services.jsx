...
const Services = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Our Services - Boomabrovers Construction | Construction Services in Nigeria</title>
        <meta name="description" content="Explore Boomabrovers Construction's comprehensive range of construction services. From residential to commercial and industrial projects, we deliver excellence in every build." />
        <meta name="keywords" content="construction services Nigeria, building services, construction company services, residential construction, commercial construction, industrial construction" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "ItemList",
            "name": "Boomabrovers Construction Services",
            "description": "List of construction services offered by Boomabrovers Construction",
